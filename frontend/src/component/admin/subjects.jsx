...
export default function SubjectManagement() {
  ...
  const handleDelete = async (subjectId) => {
    ...
    showConfirmDialog(
      ...
      async () => {
        try {
          const res = await authenticatedFetch(`http://localhost:5000/api/admin/subjects/${subjectId}`, {
            method: "DELETE",
          });
  ...
  const filteredSubjects = subjects.filter(subject => {
    ...
    const matchesSemester = !filterSemester || subject.semester._id === filterSemester;
      ...
      <div className=" flex-1 p-2 sm:p-4 md:p-6 lg:p-8 w-full mx-auto ml-0 max-[880px]:ml-0 min-[881px]:ml-65 max-[880px]:pt-20 pt-4 sm:pt-6 md:pt-8 lg:pt-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-2 sm:gap-4">
          ...
          >
            ...
            <span className="xs:hidden">Add Subject</span>
          </button>
        </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredSubjects.map((subject) => (
                        <tr key={subject._id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">
                              {subject.semester ? `${subject.semester.schoolYear} - ${subject.semester.term}` : "N/A"}
                            </div>
                          </td>
                      ...
                      <div className="flex flex-col space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <div className="mt-1 text-gray-900 text-xs sm:text-sm">
                              {subject.college}
                            </div>
                          </div>
