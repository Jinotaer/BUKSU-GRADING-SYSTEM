...
export function PageHeader({ onExport, disabled }) {
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-3">
              <h2 className="pt-4 mr-2.5 sm:pt-6 md:pt-4 lg:pt-6 font-outfit text-[#1E3A5F] text-xl sm:text-2xl lg:text-3xl font-bold">
                Grade Management
              </h2>
              <button
                onClick={() => setShowGradeInfo(true)}
                className="flex items-center mt-6 ml-2.5 gap-2 px-3 py-1 text-sm bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors"
