...
export const HiddenSectionCard = ({
  section,
  onViewDetails,
  onUnhideClick,
  formatDate,
}) => {
  const hiddenInfo = section.hiddenByStudents?.find(() => true);
      ...
      <div className="p-4">
        ...
        <div className="space-y-2 mb-3 text-sm">
          ...
          <div className="flex items-center gap-2 text-gray-500 text-xs">
            ...
            <span>Hidden {formatDate(hiddenInfo?.hiddenAt)}</span>
          </div>
        </div>

        <div className="pt-3 border-t border-gray-100 grid grid-cols-2 gap-2">
          <button
            onClick={(e) => onUnhideClick(section, e)}
